...
describe("AppFooter", () => {
    ...
    it("displays sources attribution text", () => {
        ...
        expect(getByText(/Sources: GOV.UK State Pension age guidance/i)).toBeInTheDocument();
    });
    ...
    it("has a feedback link", () => {
        const { container } = render(AppFooter);
        const feedbackLink = container.querySelector('a[href="https://tally.so/r/q4Vbq2"]');
    ...
    it("has a GitHub link", () => {
        const { container } = render(AppFooter);
        const githubLink = container.querySelector('a[href="https://github.com/telecasterer/ukspcal"]');
    ...
    it("GitHub link opens in new tab", () => {
        const { container } = render(AppFooter);
        const githubLinks = Array.from(container.querySelectorAll('a[href="https://github.com/telecasterer/ukspcal"]'));
