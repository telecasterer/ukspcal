...
- migrate legacy Svelte 4 syntax and correct print colour mismatch (56ab094)
...
- fully restore defaults and fallback to system theme (d60f8a2)
...
- tweaked the wording on the claiming page (8c721eb)

## 2026-02-28 (v0.4.0)

### Features

- Added claiming pension page and date to claim in summary (9e584c9)
...
- more PWA tweaks for stores (377c393)
